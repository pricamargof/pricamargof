...
| Chicago Ride-Sharing Analysis (Zuber) | [Zuber_Project](https://github.com/pricamargof/Zuber_Project/blob/main/Zuber_Project.ipynb) | Python | **Data Analysis and Hypothesis Testing** for a new ride-sharing company. Combined **SQL queries** with Python for trips and weather datasets. Explored **passenger preferences** and the impact of weather on ride frequency. Built **visualizations** for trip distributions and top destinations. Tested ride duration differences Loop → O’Hare on **rainy Saturdays**. |
| Video Games Market Analysis (Ice, 2016 dataset) | [Games_Market_Analysis](https://github.com/pricamargof/Games_Market_Analysis/blob/main/Games_Market_Analysis.ipynb) | Python | **Data Preprocessing, EDA and Statistical Analysis** on video game sales and ratings. Studied **platform lifecycles**, **genre profitability**, and market dynamics. Evaluated **critic/user scores correlations** with global sales. Performed **hypothesis testing** on platforms (Xbox vs PC) and genres. Provided insights to guide **marketing decisions** for 2017. |
| Statistical Analysis of Telecom Plans (Megaline) | [Megaline_Project](https://github.com/pricamargof/Megaline_project/blob/main/megaline_project.ipynb) | Python | **Exploratory Data Analysis and Hypothesis Testing** using data from 500 customers. Analyzed user behavior across Surf and Ultimate plans (calls, messages, internet). **Calculated monthly revenue** and compared average income across groups. Applied **statistical tests** to determine revenue differences by plan and region. Delivered insights to support **business strategy. |
